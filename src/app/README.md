...
As `books-manager` is quite minimal, take a look at the two provided submodules
...
One of the design philosophies of `books-manager` is that tests should exist
